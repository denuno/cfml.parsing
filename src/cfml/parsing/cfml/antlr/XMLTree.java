// $ANTLR 3.4 /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g 2012-02-26 00:34:48
...
public class XMLTree extends TreeParser {
    ...
    // $ANTLR start "element"
    // /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g:14:1: element : ^( ELEMENT name= GENERIC_ID ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )* ( element |text= PCDATA )* ) ;
    public final void element() throws RecognitionException {
        ...
        try {
            // /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g:15:5: ( ^( ELEMENT name= GENERIC_ID ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )* ( element |text= PCDATA )* ) )
            // /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g:15:7: ^( ELEMENT name= GENERIC_ID ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )* ( element |text= PCDATA )* )
            {
            ...
            // /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g:17:13: ( ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE ) )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g:18:17: ^( ATTRIBUTE attrName= GENERIC_ID value= ATTR_VALUE )
            	    {
            ...
            // /Users/valliant/Projects/java/CFML/cfml.parsing/antlr/concept/XMLTree.g:22:13: ( element |text= PCDATA )*
            loop2:
            do {
                int alt2=3;
