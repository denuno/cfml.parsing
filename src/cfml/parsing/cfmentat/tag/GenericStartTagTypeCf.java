...
public class GenericStartTagTypeCf extends StartTagTypeGenericImplementation {
	...
	protected ArrayList parseAttr(String Input, int StartLine, int StartPos) {
		...
		/*
		 * System.out.println(""); System.out.println("PARSING ATTRIBUTES:"+Input); System.out.println("\\\\Tokens:");
		 * for (int i=0;i<TokenMax;i++) { System.out.println(i+":"+Tokens[i]); } System.out.println("//tokens;");
		 * System.out.println("");
		 */
