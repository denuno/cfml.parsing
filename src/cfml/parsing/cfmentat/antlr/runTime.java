...
/**
 * The <code>runTime</code> is a class to facilitate the interface to the expression
 * engine.
 */
...
public class runTime extends Object {
	...
	public static cfData runExpression( cfSession Session, CFExpression expression, boolean _fullyEvaluate ) throws cfmRunTimeException {
		...
		if ( _fullyEvaluate ) {
			return runTime.run( Session, expression );
		} else {
	...
	public static cfData runExpression( cfSession Session, CFExpression expression ) throws cfmRunTimeException {
		return runTime.runExpression( Session, expression, true );
	}
	...
	public static cfData runExpression( cfSession Session, String variable ) throws cfmRunTimeException {
		return runTime.runExpression( Session, variable, true );
	}
	

	/** 
	 * This version of run() will return the cfData resulting from the evaluation
	 * of the given expression. It will not fully evaluate the cfData if it
	 * an instance of cfLData. This is used in the functions.setVariable class.
	 */
  ...
  // this method is only invoked from CFSCRIPT.render()
	public static CFStatementResult run( cfSession Session, CFScriptStatement statement )
    throws cfmRunTimeException {
		return statement.Exec( Session.getCFContext() );
	}
	
	public static CFStatementResult run( cfSession Session, CFStatement statement )
  throws cfmRunTimeException {
		return statement.Exec( Session.getCFContext() );
	}
