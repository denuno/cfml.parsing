...
public class poundSignFilterStream extends FilterReader {
	...
	public static void main( String[] args ) {
		...
		inputList
		    .add( "/*aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\r\n"
		...
		for ( int i = 0; i < inputList.size(); i++ ) {
			...
			try {
				poundSignFilterStream psf = new poundSignFilterStream(
				    new java.io.StringReader( input ) );
				char[] buffer = new char[1024];
				int read = psf.read( buffer );
				System.out.println( "BEFORE: " + input.length() + "; AFTER: " + read
				    + "; Added: " + psf.added + "; Total = " + ( read - psf.added ) );
